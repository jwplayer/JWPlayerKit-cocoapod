 ...
 */
@interface OMIDJwplayerAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDJwplayerPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDJwplayerPartner *)partner
                               ...
                               resources:(NSArray<OMIDJwplayerVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;

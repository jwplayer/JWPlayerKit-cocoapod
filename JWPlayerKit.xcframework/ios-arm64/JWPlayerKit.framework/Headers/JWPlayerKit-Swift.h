...
@property (nonatomic, weak) id <JWPlayerViewControllerDelegate> _Nullable delegate SWIFT_DEPRECATED_MSG("Use either the fullScreenDelegate, uiDelegate, or relatedDelegate.");
...
SWIFT_PROTOCOL("_TtP11JWPlayerKit30JWPlayerViewControllerDelegate_") SWIFT_DEPRECATED_MSG("Use either JWPlayerViewControllerFullScreenDelegate, JWPlayerViewControllerUIDelegate, or JWPlayerViewControllerRelatedDelegate.")
@protocol JWPlayerViewControllerDelegate <JWPlayerViewControllerFullScreenDelegate, JWPlayerViewControllerRelatedDelegate, JWPlayerViewControllerUIDelegate>
@end

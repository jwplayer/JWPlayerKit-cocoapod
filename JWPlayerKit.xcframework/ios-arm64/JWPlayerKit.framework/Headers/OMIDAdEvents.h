 ...
 */
@interface OMIDJwplayerAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDJwplayerAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDJwplayerVASTProperties *_Nonnull)vastProperties

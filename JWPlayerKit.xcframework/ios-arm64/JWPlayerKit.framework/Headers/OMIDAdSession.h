 ...
 */
@interface OMIDJwplayerAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDJwplayerAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDJwplayerAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDJwplayerAdSessionContext *)context
